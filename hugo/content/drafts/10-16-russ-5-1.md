...
Beides ist aber ein Zentrales Thema in Christentum. Der schwierige Drahtseilakt besteht aus dem (scheinbaren) Pardox, das eine Religion, wie das Christentum einerseits das Heilsversprechen einer Erlösung beinhaltet, und aber andererseits den Gläubigen mit Dingen konfrontiert die extrem abstossent und traumatisch sind. Deshalb halte ich es für wichtig zu betonen, das eine psychische Gesundheit wichtige Voraussetzung ist und nicht das ziel einer spirituellen Reise. So wie ich nicht erwarten kann, das ein Gottesdienstbesuch mein Karies beseitigt, so wird ein Gottesdienst auch meine psychischen Gesundheit nicht Herstellen können. Und so, wie heftiger Zahnschmerz verhindert, das ich dem Gottesdienst volgen kann, so werden meine ungelösten psychischen Probleme, mich beeinträchtigen, eine spirituelle erfülltes Gemeindeleben zu erfahren.

Soweit die Warnung vorab. Ab auf der anderen Seite des Drahtseils müssen wir zur Kenntnis nehmen, weder die Bibel noch das Christliche Weltbild ist ein ***Feel-good-Movie***! Das Christentum sieht das Böse, das Unzulängliche, den Schmerz und das Vergängliche (Glück) hier auf der Erde. Und es stellt sich dem. Auch wenn auf Esoterik-Messen und in Live-Style-Magazinen suggeriert wird, bei dem Wohlfühl-Buddismus sei da ganz anders, stimmt das einfach nicht. Die Basis des buddhistischen Weltbilds sind die ***[Vier edle Wahrheiten](https://de.wikipedia.org/wiki/Vier_edle_Wahrheiten)***:
